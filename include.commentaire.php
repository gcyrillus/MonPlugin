<?php  if(!defined('PLX_ROOT')) exit;
    ...
    # mettre true au lieu de false pour afficher les liens de chaque page
	$intermediaire = false; 

	# mettre a true pour afficher la dernière page des commentaires par défaut
	$showLast = true;
	...
	if(count($comments)>0) {
		...
		foreach($pagecomments as $com =>$val) { # On boucle sur les commentaires 	
			...
			<small>
			<a class="nbcom" href="https://pluxopolis.net/'.$_SERVER['REQUEST_URI'].'#com-'.$val['num'].'" title="#commentaire '.$val['num'].'">#'.$val['num'].'</a> 
